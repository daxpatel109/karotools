...
<div style={{ background: "rgba(56, 189, 248, 0.05)", border: "1px solid rgba(56, 189, 248, 0.2)", padding: "24px", borderRadius: "16px", margin: "32px 0" }}>
  <h3 style={{ color: "#38bdf8", marginTop: 0, fontSize: "20px", fontWeight: "700" }}>Instantly Calculate Your Tax Breakdown</h3>
  ...
  <Link data-analytics="guide_cta_gst_calculator_click" href="/gst-calculator" style={{ display: "inline-block", background: "linear-gradient(135deg, #38bdf8, #0ea5e9)", color: "#0f172a", padding: "12px 24px", borderRadius: "10px", textDecoration: "none", fontWeight: "700", fontSize: "15px" }}>
...
<div style={{ background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.2)", padding: "24px", borderRadius: "16px", margin: "32px 0" }}>
  <h3 style={{ color: "#10b981", marginTop: 0, fontSize: "20px", fontWeight: "700" }}>Automate Your Invoices</h3>
  <p style={{ marginBottom: "16px", color: "var(--text-secondary)" }}>
  ...
  <Link data-analytics="guide_cta_invoice_generator_click" href="/invoice-generator" style={{ display: "inline-block", background: "linear-gradient(135deg, #10b981, #059669)", color: "#fff", padding: "12px 24px", borderRadius: "10px", textDecoration: "none", fontWeight: "700", fontSize: "15px" }}>
...
<div style={{ marginTop: "48px", borderTop: "1px solid var(--border-color)", paddingTop: "40px" }}>
  ...
  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(250px, 1fr))", gap: "20px" }}>
    ...
    <Link href="/guides/how-to-make-gst-invoice-online-free" style={{ padding: "20px", borderRadius: "12px", border: "1px solid var(--glass-border)", textDecoration: "none", display: "flex", flexDirection: "column", gap: "8px", background: "var(--glass-bg)" }}>
      <strong style={{ color: "var(--text-primary)", fontSize: "16px" }}>How to Make GST Invoice Guide</strong>
    </Link>
    <Link href="/guides/hsn-sac-codes-freelancers" style={{ padding: "20px", borderRadius: "12px", border: "1px solid var(--glass-border)", textDecoration: "none", display: "flex", flexDirection: "column", gap: "8px", background: "var(--glass-bg)" }}>
      <strong style={{ color: "var(--text-primary)", fontSize: "16px" }}>HSN & SAC Codes Guide</strong>
    </Link>
  </div>
</div>

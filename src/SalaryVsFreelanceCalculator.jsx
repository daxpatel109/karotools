    ...
    Karo<span style={{ background: "linear-gradient(135deg, #0076ff, #005ae6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Tools</span>
      ...
      <div style={{ padding: "60px 5vw", maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 5vw, 48px)", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", margin: "0 0 16px 0", lineHeight: "1.1", letterSpacing: "-1px" }}>Salary vs Freelance</h1>

          <p style={{ fontSize: "16px", color: "var(--text-secondary)", margin: 0, maxWidth: "600px", marginInline: "auto" }}>Find out exactly how much you need to charge as a freelancer to maintain your current full-time salaried lifestyle.</p>
        </div>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "32px" }}>
          {/* Left Panel - Inputs */}
          <div style={{ background: "var(--glass-bg)", border: "1px solid var(--glass-bg)", borderRadius: "24px", padding: "32px" }}>
            <h2 style={{ fontSize: "18px", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "24px" }}>Your Job Metrics</h2>
            ...
            <div style={{ display: "grid", gap: "20px" }}>
              ...
              <h2 style={{ fontSize: "18px", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "4px" }}>Freelance Estimates</h2>

              <div>
                <label style={{ display: "flex", justifyContent: "space-between", fontSize: "13px", fontWeight: "700", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "8px" }}><span>Freelance Expenses / Month</span> <span style={{color: "#10b981"}}>₹{fmt(monthlyExpenses)}</span></label>
                ...
                <p style={{ fontSize: "12px", color: "var(--text-secondary)", marginTop: "8px" }}>Software, hardware, internet, health insurance.</p>
              </div>

              <div>
                <label style={{ display: "flex", justifyContent: "space-between", fontSize: "13px", fontWeight: "700", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "8px" }}><span>Days off per year</span> <span style={{color: "#10b981"}}>{leaves} Days</span></label>
                ...
                <p style={{ fontSize: "12px", color: "var(--text-secondary)", marginTop: "8px" }}>Holidays, sick days, vacations (excluding weekends).</p>
              </div>

              <div>
                <label style={{ display: "flex", justifyContent: "space-between", fontSize: "13px", fontWeight: "700", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "8px" }}><span>Billable Hours / Day</span> <span style={{color: "#10b981"}}>{billableHours} Hours</span></label>
                ...
                <p style={{ fontSize: "12px", color: "var(--text-secondary)", marginTop: "8px" }}>Time actually spent coding/designing for a client.</p>
              </div>
            </div>
          </div>

          {/* Right Panel - Results */}
          <div style={{ background: "linear-gradient(180deg, rgba(16,185,129,0.1) 0%, var(--glass-bg) 100%)", border: "1px solid rgba(16,185,129,0.2)", borderRadius: "24px", padding: "32px", display: "flex", flexDirection: "column" }}>
            <div style={{ marginBottom: "auto" }}>
              ...
              <div style={{ background: "var(--bg-tertiary)", border: "1px solid var(--glass-bg)", borderRadius: "16px", padding: "20px" }}>
                <h3 style={{ fontSize: "14px", fontWeight: "700", color: "var(--text-primary)", marginBottom: "12px" }}>Why so high?</h3>
                <ul style={{ listStyle: "none", padding: 0, margin: 0, fontSize: "13px", color: "var(--text-secondary)", display: "grid", gap: "10px" }}>

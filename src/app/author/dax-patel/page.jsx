...
export default function Author() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", fontFamily: "'DM Sans', sans-serif", color: "var(--text-primary)" }}>
      ...
      {/* Navbar */}
      <nav style={{ position: "sticky", top: 0, zIndex: 100, padding: "0 40px", padding: "10px 24px", minHeight: "70px", display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center", justifyContent: "space-between", background: "var(--bg-primary)", backdropFilter: "blur(20px)", borderBottom: "1px solid var(--glass-bg)" }}>
  ...
  <span style={{ fontSize: "22px", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)" }}>
    Karo<span style={{ background: "linear-gradient(135deg, #0076ff, #005ae6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Tools</span>
        ...
        <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
          <Link href="/blog" style={{ color: "var(--text-secondary)", fontSize: "14px", fontWeight: "600", textDecoration: "none" }}>Blog</Link>
        </div>
      </nav>

      {/* Profile Header */}
      <div style={{ position: "relative", overflow: "hidden", padding: "80px 24px", borderBottom: "1px solid var(--glass-bg)" }}>
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ position: "relative", width: "160px", height: "160px", marginBottom: "32px" }}>
            ...
            <div style={{ width: "160px", height: "160px", borderRadius: "50%", overflow: "hidden", background: "var(--bg-tertiary)", border: "4px solid #1e293b", position: "relative", zIndex: 1 }}>
              <img 
                src="/dax-profile.jpg" 
                alt="Dax Patel" 
              ...
              />
              <div style={{ display: "none", width: "100%", height: "100%", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, #1e293b, var(--bg-tertiary))", color: "var(--text-primary)", fontSize: "64px", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
                DP
              </div>
            </div>
          </div>

          <h1 style={{ fontSize: "clamp(40px, 6vw, 56px)", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "16px" }}>Dax Patel</h1>
          <p style={{ fontSize: "20px", color: "#a78bfa", fontWeight: "600", marginBottom: "32px" }}>Founder & Lead Developer at KaroTools</p>
          
          <p style={{ fontSize: "18px", color: "var(--text-secondary)", lineHeight: "1.8", maxWidth: "680px" }}>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "80px 24px 120px" }}>
        <h2 style={{ fontSize: "28px", fontWeight: "800", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "40px", display: "flex", alignItems: "center", gap: "16px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          {/* Post 1 */}
          <Link href="/blog/section-44ada-freelancers" style={{ display: "block", textDecoration: "none", padding: "32px", background: "var(--glass-bg)", borderRadius: "20px", border: "1px solid var(--glass-bg)", transition: "all 0.3s", cursor: "pointer" }}
            ...
            <h3 style={{ fontSize: "24px", fontWeight: "700", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "12px" }}>
          ...
          {/* Post 2 */}
          <Link href="/blog/msme-45-day-rule" style={{ display: "block", textDecoration: "none", padding: "32px", background: "var(--glass-bg)", borderRadius: "20px", border: "1px solid var(--glass-bg)", transition: "all 0.3s", cursor: "pointer" }}>
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px", alignItems: "center" }}>
              ...
              <span style={{ color: "var(--text-secondary)", fontSize: "14px" }}>June 6, 2026</span>
            </div>
            <h3 style={{ fontSize: "24px", fontWeight: "700", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "12px" }}>
          ...
          {/* Post 3 */}
          <Link href="/blog/advance-tax-for-freelancers-india" style={{ display: "block", textDecoration: "none", padding: "32px", background: "var(--glass-bg)", borderRadius: "20px", border: "1px solid var(--glass-bg)", transition: "all 0.3s", cursor: "pointer" }}>
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px", alignItems: "center" }}>
              ...
              <span style={{ color: "var(--text-secondary)", fontSize: "14px" }}>June 14, 2026</span>
            </div>
            <h3 style={{ fontSize: "24px", fontWeight: "700", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "12px" }}>
          ...
          {/* Post 4 */}
          <Link href="/blog/freelance-hourly-rate-vs-salary-india" style={{ display: "block", textDecoration: "none", padding: "32px", background: "var(--glass-bg)", borderRadius: "20px", border: "1px solid var(--glass-bg)", transition: "all 0.3s", cursor: "pointer" }}>
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px", alignItems: "center" }}>
              ...
              <span style={{ color: "var(--text-secondary)", fontSize: "14px" }}>June 15, 2026</span>
            </div>
            <h3 style={{ fontSize: "24px", fontWeight: "700", fontFamily: "'Plus Jakarta Sans',sans-serif", color: "var(--text-primary)", marginBottom: "12px" }}>
          ...
          {/* Post 5 */}
          <Link href="/blog/gst-registration-threshold" style={{ display: "block", textDecoration: "none", padding: "32px", background: "var(--glass-bg)", borderRadius: "20px", border: "1px solid var(--glass-bg)", transition: "all 0.3s", cursor: "pointer" }}>
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px", alignItems: "center" }}>
              <span style={{ background: "rgba(251,191,36,0.1)", color: "#fbbf24", padding: "6px 14px", borderRadius: "50px", fontSize: "12px", fontWeight: "700", letterSpacing: "0.05em" }}>TAX & COMPLIANCE</span>
              <span style={{ color: "var(--text-secondary)", fontSize: "14px" }}>June 15, 2026</span>
            </div>
          ...
          {/* Post 6 */}
          <Link href="/blog/how-to-make-gst-invoice-online-free" style={{ display: "block", textDecoration: "none", padding: "32px", background: "var(--glass-bg)", borderRadius: "20px", border: "1px solid var(--glass-bg)", transition: "all 0.3s", cursor: "pointer" }}>
            <div style={{ display: "flex", gap: "12px", marginBottom: "16px", alignItems: "center" }}>
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: "16px", lineHeight: "1.6", margin: 0 }}>
              A simple guide to creating valid GST invoices for your clients. Learn the required fields, HSN codes, and how to use the free KaroTools invoice generator.
            </p>
          </Link>
      ...
      {/* Footer minimal */}
      <footer style={{ borderTop: "1px solid var(--glass-bg)", padding: "40px", textAlign: "center", color: "var(--text-secondary)", fontSize: "14px", display: "flex", flexDirection: "column", gap: "24px", alignItems: "center" }}>

    ...
    <div style={{ minHeight: "100vh", background: "#020617", fontFamily: "'DM Sans', sans-serif", color: "#f8fafc", position: "relative", overflow: "hidden" }}>
      ...
      <nav style={{ padding: "0 40px", height: "70px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.05)", background: "rgba(2,6,23,0.9)", backdropFilter: "blur(20px)", position: "sticky", top: 0, zIndex: 10 }}>
        <Link to="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{ width: "32px", height: "32px", borderRadius: "9px", background: "linear-gradient(135deg,#10b981,#059669)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px" }}>⚡</div>
          <span style={{ fontSize: "20px", fontWeight: "800", fontFamily: "'Syne',sans-serif", background: "linear-gradient(135deg,#34d399,#6ee7b7)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>KaroTools</span>
        </Link>
        <div style={{ display: "flex", gap: "20px" }}>
          <Link to="/" style={{ color: "#94a3b8", fontSize: "14px", fontWeight: "600", textDecoration: "none" }}>Home</Link>
          <Link to="/blog" style={{ color: "#94a3b8", fontSize: "14px", fontWeight: "600", textDecoration: "none" }}>Blog</Link>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: "1200px", margin: "60px auto", padding: "0 24px" }}>
        ...
        {/* Disclaimer */}
        <div style={{ marginTop: "24px", padding: "16px", background: "rgba(245,158,11,0.05)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: "12px", color: "#fbbf24", fontSize: "14px", lineHeight: "1.6" }}>
          <strong>Disclaimer:</strong> Mutual fund investments are subject to market risks. The estimated returns generated by this SIP calculator are based on a projected annual growth rate and do not guarantee future performance. Please read all scheme-related documents carefully before investing.
        </div>

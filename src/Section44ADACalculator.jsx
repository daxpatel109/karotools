              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "32px" }}>
                  ...
                  <div style={{ opacity: data.isOverLimit ? 0.3 : 1, position: "relative", filter: data.isOverLimit ? "grayscale(100%)" : "none" }}>
                    {data.isOverLimit && (
                      <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", background: "var(--card-bg)", padding: "12px 16px", borderRadius: "12px", color: "#fca5a5", fontSize: "14px", fontWeight: "700", textAlign: "center", width: "85%", zIndex: 10, border: "1px solid rgba(248,113,113,0.3)", backdropFilter: "blur(4px)" }}>
                    ...
                    <div style={{ background: "var(--glass-bg)", borderRadius: "8px", padding: "12px" }}>
